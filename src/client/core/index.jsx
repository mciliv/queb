...
const suppressExtensionErrors = (message) => {
...
// Suppress all Chrome extension runtime errors
window.addEventListener('error', (e) => {
  if (suppressExtensionErrors(e.message) || suppressExtensionErrors(e.filename)) {
    e.preventDefault();
    e.stopPropagation();
    return false;
  }
...
window.addEventListener('unhandledrejection', (e) => {
  if (suppressExtensionErrors(e.reason?.message || e.reason)) {
    e.preventDefault();
    e.stopPropagation();
    return false;
  }
