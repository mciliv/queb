...
function inputToNames(objectDescription) {
  return `Task: Identify only fully specific chemical molecules present in the object. JSON response.

Object: ${objectDescription}

Requirements:
- Output ONLY fully specific molecule names (unique common names or IUPAC). No classes/families (e.g., "polyphenols", "sugars", "lipids"), no brand names.
...
module.exports = { inputToName: inputToNames };
