 ...
 * 
 * ⚠️ CRITICAL: The OpenAI response structure MUST be loaded from ./openai_respone.json
 ...
 * ALWAYS reference ./openai_respone.json for the response contract.
 */
 ...
 *
 * ⚠️ IMPORTANT: This function MUST load from ./openai_respone.json
 ...
 *
 * @returns {Object} The contract schema from ./openai_respone.json
 */
function loadOpenAIResponseContract() {
  // CRITICAL: Use ./openai_respone.json - this is the source of truth
  const contractPath = path.join(__dirname, 'openai_respone.json');
...
// Load the contract - this MUST come from ./openai_respone.json
...
/**
 * Creates a successful AI response mock based on the contract from ./openai_respone.json
 *
 * ⚠️ IMPORTANT: This function MUST conform to the structure in ./openai_respone.json
 ...
 * @returns {Object} Mock OpenAI API response conforming to ./openai_respone.json structure
 */
function createSuccessfulAIResponse(object, chemicals = [], options = {}) {
  ...
  // Use the Responses API format from ./openai_respone.json
